    ...
    if ($admin == 1) { //是否為管理員
        ...
        if ($city == '' || $element == '') {
            ...
            if ($city == '請選擇' || $element == '請選擇') {
                echo "請選擇縣市及天氣因子";
                header("location.href='admin_weather_revise.php'");
            }
        ...
        if ($s) {
            while ($result_row = mysqli_fetch_array($result)) {
                ...
                echo "<form name='form' method='post' action='admin_weather_revise_action.php?startTime=$startTime&endTime=$endTime'>
